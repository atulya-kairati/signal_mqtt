...
class MyIconPicker extends StatefulWidget {
  const MyIconPicker({
    Key key,
    Null Function(String name) onIconSelection,
  })  : _onIconSelection = onIconSelection,
        super(key: key);

  final Null Function(String name) _onIconSelection;
            ...
            child: RaisedButton(
              ...
              onPressed: () {
                _openDialog(
                  ...
                  context: context,
                  content: Container(
                    /// to set the height and widht of alert
                    /// change width and height of this container
                    ...
                    child: GridView.builder(
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                          ...
                          mainAxisSpacing: 10,
                          crossAxisCount: 6),
                      itemCount: mIcons.values.length,
                      itemBuilder: (BuildContext context, int index) {
                        return IconButton(
                          icon: Icon(
                            mIcons.values.toList()[index],
                          ),
                          onPressed: () {
                            // setState(() {
                            //   icon = mIcons.keys.elementAt(index);
                            // });

                            widget
                                ._onIconSelection(mIcons.keys.elementAt(index));
                            iconName = mIcons.keys.elementAt(index);
...
Map<String, IconData> mIcons = {
  ...
  'add_photo_alterno_home_screen': Icons.add_to_home_screen,
